...
* **Branch stack (none merged): `phase0/baseline-safety-net` (PR #7) ← `phase1/latent-bug-fixes`
  (PR #8) ← `phase2/core-extraction` (PR #9, Phase 2a) ← `phase3/sequence-identity` (PR #10) ← `phase4/binary-formats` (PR #11) ← `phase4b/libsvm-train` (PR #12) ← `phase5/alphabet-generalisation`.** See §7 of the plan for what each contains and what
